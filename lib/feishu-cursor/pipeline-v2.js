...
function createFeishuCursorPipelineV2(deps) {
  ...
  async function runPipelineV2Legacy(data) {
    ...
    emitStageLatency(d, "parse", tParseStart, { messageId: msgId || "" });
    ...
    emitStageLatency(d, "planning_pre", tPlanningProbeStart, { chatId: extracted.chatId || "", messageId: extracted.messageId || "" });
    ...
    emitStageLatency(d, "planning_final", tPlanningFinalStart, {
      chatId: extracted.chatId || "",
    ...
    emitStageLatency(d, "memory", tMemoryStart, {
      chatId: extracted.chatId || "",
      messageId: extracted.messageId || "",
    ...
    const queued = await d.taskQueue.enqueue(async () => {
      ...
      if (wf) {
        ...
        try {
          ...
          emitStageLatency(d, "workflow_plugin", tWorkflowStart, { chatId: extracted.chatId || "", messageId: extracted.messageId || "", fallback: true });
          return originalExecution();
        }
        emitStageLatency(d, "workflow_plugin", tWorkflowStart, { chatId: extracted.chatId || "", messageId: extracted.messageId || "", workflowType: planClassification.workflowKey || planClassification.taskType || "general" });
    ...
    emitStageLatency(d, "output_plugins", tOutputStart, { chatId: extracted.chatId || "", messageId: extracted.messageId || "", outputPluginsEnabled: featureFlags.isEnabled("outputPlugins") });

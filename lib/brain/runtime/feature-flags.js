...
const DEFINITIONS = Object.freeze({
  newKernel: { env: "FEISHU_BRAIN_NEW_KERNEL", defaultValue: true, productionDefaultValue: false },
  ...
  workflowHint: { env: "FEISHU_BRAIN_WORKFLOW_HINT", defaultValue: true, productionDefaultValue: false },
  clarifyFooter: { env: "FEISHU_BRAIN_CLARIFY_FOOTER", defaultValue: true, productionDefaultValue: false },
});
...
function isProductionEnv(env) {
  ...
  return String((e && (e.FEISHU_BRAIN_ENV || e.NODE_ENV)) || "").trim().toLowerCase() === "production";
}

function defaultFor(def, env) {
  if (isProductionEnv(env) && Object.prototype.hasOwnProperty.call(def, "productionDefaultValue")) {
    return !!def.productionDefaultValue;
  }

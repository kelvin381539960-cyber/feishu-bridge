...
> This document defines the phased implementation roadmap for moving `feishu-bridge` toward a governable AI workflow system. It belongs under `docs/workflow-governance/` because it is a reform plan, not only an AI reading entrypoint.
...
|---:|---|---|---|---|
| 0 | Context Stabilization | 稳定 AI 阅读入口和仓库地图 | `docs/ai-context/*` + `docs/workflow-governance/*` | 否 |
| 1 | Current-State Audit | 梳理现有工作流与代码现状 | `workflow-current-state.md` | 否 |
...
| `docs/ai-context/00-migration-note.md` | done | AI context 迁移降权说明 |
| `docs/workflow-governance/README.md` | done | 工作流治理目录说明 |
| `docs/workflow-governance/workflow-governance-map.md` | done | 工作流治理地图 |
| `docs/workflow-governance/implementation-roadmap.md` | current | 实施路线图 |
| `docs/workflow-governance/task-entrypoints.md` | todo | 不同任务类型的读取入口 |
| `docs/workflow-governance/workflow-current-state.md` | todo | 当前系统现状审计 |
...
```text
1. 完成 task-entrypoints.md 迁移
2. 完成 workflow-current-state.md 迁移
...
| `docs/ai-context/00-migration-note.md` | ai-context 迁移降权说明 |
| `docs/workflow-governance/workflow-governance-map.md` | 治理结构地图 |
| `docs/workflow-governance/implementation-roadmap.md` | 分阶段实施路线 |
...
如果未来出现 `docs/migration/`、`docs/harness/`、`docs/runtime/`、`docs/agent-os/` 等新架构文档，应以新架构文档和当前代码事实为准。
